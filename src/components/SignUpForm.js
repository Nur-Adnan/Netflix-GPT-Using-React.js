  ...
  return (
    <div className="bg-black/70 w-full sm:w-[450px] m-auto px-6 md:px-16 py-8 md:py-12 mx-4 sm:mx-auto flex items-center rounded-lg">
      <div className="w-full">
        <h1 className="mb-5 text-white text-4xl font-bold">Sign Up</h1>
        {authError && (
        ...
        <div className="mb-2 text-white">
          <input
            ...
            className={`px-4 py-4 w-full bg-transparent border border-white rounded-[4px] focus:border-white focus-visible:outline-none text-sm ${
