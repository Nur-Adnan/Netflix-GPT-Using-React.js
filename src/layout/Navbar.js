  ...
  return (
    <>
      <div
        ...
        } backdrop-blur-xl md:backdrop-blur-none fixed top-0 w-full px-4 md:px-12 py-3 text-white ${
          !isLargeScreen && "ddd"
        }`}
        style={{
          zIndex: 9999999,
      ...
      >
        <div className="flex items-center">
          ...
          <div className="flex gap-6 ml-4 text-white text-sm hidden md:flex">
            <Link
              to={PAGE.BROWSE}
            ...
            <Link to={PAGE.SHOWS} className="hover:text-gray-400 font-semibold">
              TV Show
            </Link>
            <Link
              to={PAGE.MOVIES}
          ...
          <div className="gap-6 ml-auto flex items-center">
            ...
            >
              ...
              <span className="hover:text-gray-400 font-semibold">Search</span>
            </Link>
            <div className="profile-dropdown relative" ref={dropdownRef}>
              ...
              {isOpen && (
                <div className="bg-black/90 absolute z-50 right-0 top-10 min-w-[170px] pt-2 border border-gray-800 rounded-md shadow-lg">
                  <Link
                    to="/"
                    className="flex items-center px-4 py-2 gap-3 text-xs text-white hover:bg-gray-800"
                  >
                    <div className="w-5 h-5 bg-cyan-500 rounded-full"></div>
                    <div className="title">Boy</div>
                  </Link>
                  <Link
                    to="/"
                    className="flex items-center px-4 py-2 gap-3 text-xs text-white hover:bg-gray-800"
                  ...
                  <div className="px-2 gap-3 text-xs text-slate-300 flex justify-center items-center border-t border-gray-700 mt-4 hover:text-white">
                    <button
                      className="p-3 w-full text-left text-red-600 font-bold hover:text-white transition-colors duration-200"
