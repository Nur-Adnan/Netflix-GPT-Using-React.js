...
export const LOGO_ICON = `${BASE_URL}/Logonetflix.png`;
export const LOGO_RED = `${BASE_URL}/Logonetflix.png`;
export const LOGO_WHITE = `${BASE_URL}/Logonetflix.png`;
export const POSTER_BG = `${BASE_URL}/banner.jpg`;
